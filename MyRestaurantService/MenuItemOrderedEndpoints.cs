...
public static class MenuItemOrderedEndpoints
{
    public static void MapMenuItemOrderedEndpoints (this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<MenuItemOrdered>, NotFound>> (int id, MyRestaurantServiceContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, MenuItemOrdered menuItemOrdered, MyRestaurantServiceContext db) =>
        {
        ...
        group.MapPost("/", async (MenuItemOrdered menuItemOrdered, MyRestaurantServiceContext db) =>
        {
