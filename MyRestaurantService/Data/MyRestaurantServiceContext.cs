...
namespace MyRestaurantService.Data
{
    public class MyRestaurantServiceContext : DbContext
    {
        public MyRestaurantServiceContext (DbContextOptions<MyRestaurantServiceContext> options)
            : base(options)
        {
        }
        ...
        public DbSet<MyRestaurantService.Contact> Contact { get; set; } = default!;

        public DbSet<MyRestaurantService.MenuItem> MenuItem { get; set; } = default!;

        public DbSet<MyRestaurantService.MenuItemOrdered> MenuItemOrdered { get; set; } = default!;

        public DbSet<MyRestaurantService.TogoOrder> TogoOrder { get; set; } = default!;
