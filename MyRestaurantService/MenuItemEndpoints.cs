...
public static class MenuItemEndpoints
{
    public static void MapMenuItemEndpoints (this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<MenuItem>, NotFound>> (int id, MyRestaurantServiceContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, MenuItem menuItem, MyRestaurantServiceContext db) =>
        {
        ...
        group.MapPost("/", async (MenuItem menuItem, MyRestaurantServiceContext db) =>
        {
